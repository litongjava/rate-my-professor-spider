...
public abstract class BaseRumiRmpSchoolRatingThumb<M extends BaseRumiRmpSchoolRatingThumb<M>> extends Model<M> implements IBean {
	...
	public M setCampusRatingId(java.lang.Long campusRatingId) {
		set("campus_rating_id", campusRatingId);
		return (M)this;
	}
	
	public java.lang.Long getCampusRatingId() {
		return getLong("campus_rating_id");
	}
